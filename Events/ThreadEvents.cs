...
namespace Cliptok.Events
{
    public class ThreadEvents
    {
        ...
        {
            client.Logger.LogDebug(eventId: CliptokEventID, "Threads synced in {e.Guild.Name}.", e.Guild.Name);
            return Task.CompletedTask;
        }
        ...
        public static Task Discord_ThreadMemberUpdated(DiscordClient client, ThreadMemberUpdateEventArgs e)
        {
            ...
            client.Logger.LogDebug(CliptokEventID, "Discord_ThreadMemberUpdated fired for thread {e.ThreadMember.ThreadId}. User ID {e.ThreadMember.Id}.", e.ThreadMember.ThreadId, e.ThreadMember.Id);
            return Task.CompletedTask;
        }
